...
Widget wrapWithModel<T extends sampleModel>({
  required T model,
...
T createModel<T extends sampleModel>(
...
abstract class sampleModel<W extends Widget> {
...
class FlutterFlowDynamicModels<T extends sampleModel> {
